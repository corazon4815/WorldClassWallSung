...
<body>
	<div id="openSub" style="padding: 5px; margin-left: 300px;">
		...
		교수&nbsp;&nbsp;				<input type="text" id="prof_nm"
						value="${list.prof_nm}">
					<br>
					<br>
		&nbsp;	&nbsp;	&nbsp;	&nbsp;	&nbsp;	&nbsp;	
		학점 <input type="text" id="credit" value="${list.credit}">&nbsp;	
		강의실<input type="text" id="subroom" value="${list.subroom_nm}">
					<br>
					<br>
		...
		강의계획서	<input type="button" id="sub_path"
				...
				<input type="button" value="개설 완료" onclick="check1()"
					class="btn btn-dark" style="margin-top: 30px; margin-left: 20px;">
				<input type="button" value="개설 취소" onclick="check2()"
					class="btn btn-dark" style="margin-top: 30px; margin-left: 20px;">
				<input type="button" value="목록으로"
					onclick="location.href='StaSub1.do'" class="btn btn-dark"
